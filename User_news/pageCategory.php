    ...
    <div class="container">
      ...
      <div class="row">
      	<?php
      		...
      		$sotin = 6;
      		$from = ($page - 1)* $sotin;
      		 $query = "SELECT tintuc.`idTinTuc`,tintuc.`TieuDe`, tintuc.`TieuDeKhongDau`, tintuc.`TomTat`, tintuc.`NoiDung`, tintuc.`HinhAnh`, tintuc.`NoiBat`, tintuc.`idLoaiTin`, tintuc.`idTacGia`, tintuc.`NgayDang`, loaitin.`id`, loaitin.`Ten`, loaitin.`TenKhongDau`, loaitin.`idTheLoai` FROM tintuc,loaitin WHERE tintuc.`idLoaiTin` = loaitin.`id` AND loaitin.`idTheLoai` = $id LIMIT $from,$sotin";
            ...
            <div class="col-lg-12">
                <nav class="blog-pagination justify-content-center d-flex">
                    <ul class="pagination">
                        ...
                        <li class="page-item active"><a href="pageCategory.php?page=<?php echo $i; ?>&id=<?php echo $id; ?>" class="page-link"><?php echo $i; ?></a></li>
                        <?php
                        	}
                         ?>
                        <li class="page-item">
